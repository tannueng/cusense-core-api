...
app.use(
  ...
  (req, res, next) => {
    ...
    res.header(
      "We-moved!",
      "This API service terminated on 12 APR 2020. We moved to the new URL. Checkout https://cusense.net/portal/#!/apis/7663e426-e4e5-4cee-a3e4-26e4e57cee4c/pages/9d46f643-4652-44eb-86f6-434652b4ebb0 for the new API documentation. The new baseURL is https://www.cusense.net:8082 use alongside with the new your own API Key."
    );

    res
      .status(404)
      .send(
        "This API service terminated on 12 APR 2020.\nWe moved to the new URL.\nCheckout https://cusense.net/portal/#!/apis/7663e426-e4e5-4cee-a3e4-26e4e57cee4c/pages/9d46f643-4652-44eb-86f6-434652b4ebb0 for the new API documentation.\nThe new baseURL is https://www.cusense.net:8082 use alongside with the new your own API Key."
      );
  }
);
